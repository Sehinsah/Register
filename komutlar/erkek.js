...
const tag = '⛧'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '800373370561626134') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '800373370436452362')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '800373369840074797')
const genelchat = message.guild.channels.cache.find(c => c.id === '800373409497481226')
const savelog = message.guild.channels.cache.find(c => c.id === '800373398642753576')
