...
if(!['800373405375135755'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
await member.roles.add('800373369840074797')
